...
//             <input type="text" value={mobileInput} onChange={e => setMobileInput(e.target.value.replace(/\D/g,'').slice(0,10))} placeholder="Leave empty for all" maxLength={10} className="w-full px-4 py-2.5 bg-gray-50 border-2 border-gray-200 rounded-xl text-gray-900 text-sm focus:outline-none focus:border-amber-500" />
//           </div>
//           <div>
