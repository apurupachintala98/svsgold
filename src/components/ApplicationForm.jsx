...
//   // Auto-populate branch_name in pledge details from step 1 branch selection
//   useEffect(() => {
//     if (applicationData.place && !pledgeDetails.branch_name) {
//       setPledgeDetails(prev => ({ ...prev, branch_name: applicationData.place }))
//     }
//   }, [applicationData.place])
...
//           {pledgeDetails.branch_name && applicationData.place && pledgeDetails.branch_name === applicationData.place && (
//             <p className="text-xs text-green-600 mt-1">Auto-filled from application branch</p>
//           )}
//         </div>
//       </div>
